...
liste_centre_bouee = [np.array([[50],[-75]]),np.array([[120],[-25]]),np.array([[100],[50]]),np.array([[50],[75]])]
...
nav_bouee.bouee_suivante = liste_bouees_nav[0]
print(liste_bouees_nav)

#liste_centre_bouee = [array([[0],[0]]),array([[50],[-50]]),array([[150],[50]])]
#liste_bouees_nav = [0,1,2,1,0]
polygone_test = [[0,-50],[50,-50],[50,50],[0,50]]
rayon_gps_bouee = 20

p0,p1,p2,p3,p4,p5,p6,p7,p8,p9 = 0.1,1,6000,1000,2000,1,1,2,300,10000
x = array([[0,-75,0,0,0]]).T   #x=(x,y,θ,v,w)
